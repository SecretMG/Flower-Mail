...
public:
    ...
    void setupUi(QWidget *Register)
    {
        ...
        horizontalLayoutWidget_2->setGeometry(QRect(330, 150, 491, 51));
        ...
        horizontalLayoutWidget_3->setGeometry(QRect(330, 200, 491, 51));
        ...
        horizontalLayoutWidget_4->setGeometry(QRect(330, 250, 491, 51));
        ...
        horizontalLayoutWidget_5->setGeometry(QRect(550, 300, 271, 51));
