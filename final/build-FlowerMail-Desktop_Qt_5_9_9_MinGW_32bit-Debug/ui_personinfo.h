...
public:
    ...
    void setupUi(QWidget *Personinfo)
    {
        ...
        changeinfo_btn->setGeometry(QRect(870, 170, 121, 31));
        ...
        help_btn = new QPushButton(Personinfo);
        help_btn->setObjectName(QStringLiteral("help_btn"));
        help_btn->setGeometry(QRect(870, 240, 121, 28));
    ...
    void retranslateUi(QWidget *Personinfo)
    {
        ...
        help_btn->setText(QApplication::translate("Personinfo", "\345\270\256\345\212\251\344\270\255\345\277\203", Q_NULLPTR));
    } // retranslateUi
