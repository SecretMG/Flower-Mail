...
public:
    ...
    void setupUi(QWidget *Resetpassword)
    {
        ...
        newpwd_le->setEchoMode(QLineEdit::Password);
        ...
        checkpwb_le->setEchoMode(QLineEdit::Password);
        ...
        QObject::connect(submit_btn, SIGNAL(clicked()), Resetpassword, SLOT(judgeEmpty()));
