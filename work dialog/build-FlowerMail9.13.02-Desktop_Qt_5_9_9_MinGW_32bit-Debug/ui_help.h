...
public:
    ...
    void setupUi(QWidget *Help)
    {
        ...
        verticalLayoutWidget->setGeometry(QRect(30, 20, 160, 241));
        ...
        stackedWidget->setGeometry(QRect(230, 20, 701, 611));
        page = new QWidget();
    ...
    void retranslateUi(QWidget *Help)
    {
        ...
        pushButton->setText(QApplication::translate("Help", "\345\205\263\351\227\255\345\270\256\345\212\251", Q_NULLPTR));
    } // retranslateUi
