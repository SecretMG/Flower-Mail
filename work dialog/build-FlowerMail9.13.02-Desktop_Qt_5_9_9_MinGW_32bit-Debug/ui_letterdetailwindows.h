...
public:
    ...
    QPushButton *ReplyB;
    QPushButton *ForwardB;
    QPushButton *SaveAttachB;
    ...
    void setupUi(QMainWindow *LetterDetailWindows)
    {
        ...
        ReplyB = new QPushButton(centralwidget);
        ReplyB->setObjectName(QStringLiteral("ReplyB"));
        ReplyB->setGeometry(QRect(50, 190, 93, 28));
        ForwardB = new QPushButton(centralwidget);
        ForwardB->setObjectName(QStringLiteral("ForwardB"));
        ForwardB->setGeometry(QRect(140, 190, 93, 28));
        SaveAttachB = new QPushButton(centralwidget);
        SaveAttachB->setObjectName(QStringLiteral("SaveAttachB"));
        SaveAttachB->setGeometry(QRect(230, 190, 93, 28));
    ...
    void retranslateUi(QMainWindow *LetterDetailWindows)
    {
        ...
        ReplyB->setText(QApplication::translate("LetterDetailWindows", "\345\233\236\345\244\215", Q_NULLPTR));
        ForwardB->setText(QApplication::translate("LetterDetailWindows", "\350\275\254\345\217\221", Q_NULLPTR));
        SaveAttachB->setText(QApplication::translate("LetterDetailWindows", "\344\270\213\350\275\275\351\231\204\344\273\266", Q_NULLPTR));
