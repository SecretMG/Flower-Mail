...
public:
    ...
    void setupUi(QMainWindow *WriteLetterWindow)
    {
        ...
        closewrite = new QPushButton(centralwidget);
        closewrite->setObjectName(QStringLiteral("closewrite"));
        closewrite->setGeometry(QRect(750, 0, 51, 31));
    ...
    void retranslateUi(QMainWindow *WriteLetterWindow)
    {
        ...
        closewrite->setText(QApplication::translate("WriteLetterWindow", "\345\205\263\351\227\255", Q_NULLPTR));
