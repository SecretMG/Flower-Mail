...
public:
    ...
    void setupUi(QWidget *Personinfo)
    {
        ...
        settings_info = new QPushButton(horizontalLayoutWidget_3);
        settings_info->setObjectName(QStringLiteral("settings_info"));

        buttons_layout->addWidget(settings_info);
    ...
    void retranslateUi(QWidget *Personinfo)
    {
        ...
        settings_info->setText(QApplication::translate("Personinfo", "\350\256\276\347\275\256", Q_NULLPTR));
